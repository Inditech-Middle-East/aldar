...
<div class="vertical-menu">
    ...
    <div class="navbar-brand-box">
        <a href="index" class="logo logo-dark">
            <span class="logo-sm">
                <img src="{{ URL::asset('assets/images/logo-dark-sm.png') }}" alt="" height="22" style="height: 50px;background: white;">
            </span>
            <span class="logo-lg">
                <img src="{{ URL::asset('assets/images/logo-dark.png') }}" alt="" height="22" style="height: 50px;background: white;">
            </span>
        </a>

        <a href="index" class="logo logo-light">
            <span class="logo-lg">
                <img src="{{ URL::asset('assets/images/logo-light.png') }}" alt="" height="22" style="height: 50px;background: white;">
            </span>
            <span class="logo-sm">
                <img src="{{ URL::asset('assets/images/logo-light-sm.png') }}" alt="" height="22" style="height: 50px;background: white;">
            </span>
        </a>
    </div>
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow">
                        ...
                        <span class="menu-item" data-key="t-tenant">@lang('translation.Tenant_Management')</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
					    <li><a href="tenant-tenants" data-key="t-customers">@lang('translation.Tenants')</a></li>
						<li><a href="tenant-new-tenant" data-key="t-add-product">@lang('translation.New_Tenant')</a></li>
                        
						<!--<li><a href="tenant-products" data-key="t-products">@lang('translation.Products')</a></li>
                        <li><a href="tenant-product-detail" data-key="t-product-detail">@lang('translation.Product_Detail')</a></li>
                        <li><a href="tenant-orders" data-key="t-orders">@lang('translation.Orders')</a></li>
                        
                        <li><a href="tenant-cart" data-key="t-cart">@lang('translation.Cart')</a></li>
                        <li><a href="tenant-checkout" data-key="t-checkout">@lang('translation.Checkout')</a></li>
                        <li><a href="tenant-shops" data-key="t-shops">@lang('translation.Shops')</a></li>-->
