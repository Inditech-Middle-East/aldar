                                                    ...
                                                    <div class="d-flex flex-column h-100">
                                                        <div class="mb-4 mb-md-5">
                                                            <a href="index" class="d-block auth-logo">
                                                                <img src="{{ URL::asset('assets/images/logo-light.png')}}" alt="" height="100" class="auth-logo-dark me-start">
                                                                <img src="{{ URL::asset('assets/images/logo-light.png')}}" alt="" height="100" class="auth-logo-light me-start">
                                                            </a>
                                                        </div>
                                                        <div class="auth-content my-auto">
                                                            ...
                                                            <form class="mt-4 pt-2" action="{{ route('login') }}" method="POST">
                                                                ...
                                                                <div class="form-floating form-floating-custom mb-4">
                                                                    <input type="text" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', 'sam@aldar.com') }}" id="input-username" placeholder="Enter User Name" name="email">
                                                                    @error('email')
