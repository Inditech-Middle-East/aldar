                                                    ...
                                                    <div class="d-flex flex-column h-100">
                                                        <div class="mb-4 mb-md-5">
                                                            <a href="index" class="d-block auth-logo">
                                                                <img src="<?php echo e(URL::asset('assets/images/logo-light.png')); ?>" alt="" height="100" class="auth-logo-dark me-start">
                                                                <img src="<?php echo e(URL::asset('assets/images/logo-light.png')); ?>" alt="" height="100" class="auth-logo-light me-start">
                                                            </a>
                                                        </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email', 'sam@aldar.com')); ?>" id="input-username" placeholder="Enter User Name" name="email">
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="mt-4 text-center">
                                                            <p class="mb-0">Inditech © <script>document.write(new Date().getFullYear())</script></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\AldarAdmin\resources\views/auth/login.blade.php ENDPATH**/ ?>