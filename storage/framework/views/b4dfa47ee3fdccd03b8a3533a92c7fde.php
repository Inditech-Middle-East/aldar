...
<div class="vertical-menu">
    ...
    <div class="navbar-brand-box">
        <a href="index" class="logo logo-dark">
            <span class="logo-sm">
                <img src="<?php echo e(URL::asset('assets/images/logo-dark-sm.png')); ?>" alt="" height="22" style="height: 50px;background: white;">
            </span>
            <span class="logo-lg">
                <img src="<?php echo e(URL::asset('assets/images/logo-dark.png')); ?>" alt="" height="22" style="height: 50px;background: white;">
            </span>
        </a>

        <a href="index" class="logo logo-light">
            <span class="logo-lg">
                <img src="<?php echo e(URL::asset('assets/images/logo-light.png')); ?>" alt="" height="22" style="height: 50px;background: white;">
            </span>
            <span class="logo-sm">
                <img src="<?php echo e(URL::asset('assets/images/logo-light-sm.png')); ?>" alt="" height="22" style="height: 50px;background: white;">
            </span>
        </a>
    </div>
    ...
    <div data-simplebar class="sidebar-menu-scroll">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="index" data-key="t-ecommerce" >
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow">
                        ...
                        <span class="menu-item" data-key="t-tenant"><?php echo app('translator')->get('translation.Tenant_Management'); ?></span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
					    <li><a href="tenant-tenants" data-key="t-customers"><?php echo app('translator')->get('translation.Tenants'); ?></a></li>
						<li><a href="tenant-new-tenant" data-key="t-add-product"><?php echo app('translator')->get('translation.New_Tenant'); ?></a></li>
                        
						<!--<li><a href="tenant-products" data-key="t-products"><?php echo app('translator')->get('translation.Products'); ?></a></li>
                        <li><a href="tenant-product-detail" data-key="t-product-detail"><?php echo app('translator')->get('translation.Product_Detail'); ?></a></li>
                        <li><a href="tenant-orders" data-key="t-orders"><?php echo app('translator')->get('translation.Orders'); ?></a></li>
                        
                        <li><a href="tenant-cart" data-key="t-cart"><?php echo app('translator')->get('translation.Cart'); ?></a></li>
                        <li><a href="tenant-checkout" data-key="t-checkout"><?php echo app('translator')->get('translation.Checkout'); ?></a></li>
                        <li><a href="tenant-shops" data-key="t-shops"><?php echo app('translator')->get('translation.Shops'); ?></a></li>-->
...
<!--
        ...
        <div class="p-3 px-4 sidebar-footer">
            <p class="mb-1 main-title"><script>document.write(new Date().getFullYear())</script> &copy; Inditech.</p>
            <p class="mb-0">Powered by Inditech</p>
        </div>
    </div>
</div>
<!-- Left Sidebar End -->
<?php /**PATH C:\xampp\htdocs\AldarAdmin\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>