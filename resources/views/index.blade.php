                ...
                <div class="table-responsive">
                    <table class="table align-middle table-nowrap mb-0">
						...
						@foreach ($data as $index => $row)
                            <tr>
                                <td><a href="javascript: void(0);" class="text-body fw-semibold">{{ $row->tenant_name }}</a> </td>
                                <td>{{ $row->tenant_code }}</td>
                                <td>{{ $row->mall_code }}</td>
                                <td> {{ $row->outlet_code }} </td>
                                <td>{{ $row->floor }}</span> </td>
                                <td class="text-center"> <span class="badge badge-pill badge-soft-success font-size-11">{{ $row->lease_enddate }}</span> </td>
                            </tr>
                      @endforeach	
                        </tbody>
                    </table>
